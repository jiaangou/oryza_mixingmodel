...
# community: 1 means BP, 2 means OS, group: 1 means heading , 2 means ripening, 3 means seedling, 4 means tillering
...
legend(min(ORM_data$d13C)-1.5, max(ORM_data$d15N)+1.8, legend = c("BP", "OS"), pch = c(17, 19), 
...
legend(min(ORM_data$d13C)-0.75, max(ORM_data$d15N)+1.8, legend = c("Seedling", "Tillering", "Heading", "Ripening"), lty = 1, 
       ...
       col = c("green3", "blue", "black", "red"), title.col = "black", seg.len = 0.5, 
       text.col = c("green3", "blue", "black", "red"), bty = "n") 
...
legend(min(CVM_data$d13C)-1.5, max(CVM_data$d15N)+3, legend = c("BP", "OS"), pch = c(17, 19), 
       x.intersp = 0.4, y.intersp = 0.3, cex = 1, 
       title = "Source", title.adj = c(0.4,-2), 
       bty = "n")
...
legend(min(ORG_data$d13C)-1.4, max(ORG_data$d15N)+2, legend = c("BP", "OS"), pch = c(17, 19), 
       x.intersp = 0.4, y.intersp = 0.3, cex = 1, 
       title = "Source", title.adj = c(0.4,-2), 
       bty = "n")
...
legend(min(CVG_data$d13C)-1.5, max(CVG_data$d15N)+2.25, legend = c("BP", "OS"), pch = c(17, 19), 
       x.intersp = 0.4, y.intersp = 0.3, cex = 1, 
       title = "Source", title.adj = c(0.4,-2), 
       bty = "n")
...
legend(min(ORO_data$d13C)-1.1, max(ORO_data$d15N)+2, legend = c("BP", "OS"), pch = c(17, 19), 
       x.intersp = 0.4, y.intersp = 0.3, cex = 1, 
       title = "Source", title.adj = c(0.4,-2), 
       bty = "n")
...
legend(min(CVO_data$d13C)-2.5, max(CVO_data$d15N)+3, legend = c("BP", "OS"), pch = c(17, 19), 
       x.intersp = 0.4, y.intersp = 0.3, cex = 1, 
       title = "Source", title.adj = c(0.4,-2), 
       bty = "n")
